...
/**
 * Some implementation for the ArrayIndexedCollection, the Processor,
 * and the LinkedListIndexedCollection simulation.
 * @author unknown
 * */
public class MainCollection {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("col elements:"); // [20, SF, LA]
    col.forEach(new P());
